...
const imgUrl = computed(() => {
  ...
  switch (props.image) {
    case 'collect':
      img = '/static/img/wot-ui/collect.png'
      break
    case 'comment':
      img = '/static/img/wot-ui/comment.png'
      break
    case 'content':
      img = '/static/img/wot-ui/content.png'
      break
    case 'halo':
      img = '/static/img/wot-ui/halo.png'
      break
    case 'message':
      img = '/static/img/wot-ui/message.png'
      break
    case 'network':
      img = '/static/img/wot-ui/network.png'
      break
    case 'search':
      img = '/static/img/wot-ui/search.png'
      break
    default:
      img = props.image
  }
